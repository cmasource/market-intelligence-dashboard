...
test.describe("intelligent alerts public boundary", () => {
  ...
  test("alerts are discoverable, protected and responsive without Supabase configuration", async ({ page }) => {
    ...
    await expect(page.getByText(/Supabase configuration and the database migration are required/)).toBeVisible();
