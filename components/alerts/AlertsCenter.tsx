...
import type { AlertCategory, AlertSeverity, PersonalAlertSubscription } from "@/lib/alerts";
...
export function AlertsCenter() {
  ...
  const activeSubscriptions = subscriptions.filter((subscription) => subscription.enabled).length;
