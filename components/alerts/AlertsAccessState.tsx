  ...
  return (
    <AppShell>
      <section className="cma-panel mx-auto max-w-2xl p-7 text-center">
        ...
        <Link href="/auth/login?next=%2Falerts" className="mt-6 inline-flex min-h-11 items-center gap-2 rounded-lg border border-cyan-300/35 bg-cyan-300/10 px-4 text-sm font-semibold text-cyan-100"><LogIn size={16} />{language === "es" ? "Iniciar sesión" : "Sign in"}</Link>
      </section>
    </AppShell>
  );
}
