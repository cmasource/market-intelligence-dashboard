...
function buildInterpretation(params: {
  ...
  if (impliedCcl === null) {
    return {
      ...
      bulletPoints: [
        "Local CEDEAR price and ratio remain mock structured values.",
  ...
  return {
    label: usedProvider ? "Provider underlying / mock local CEDEAR" : "Mock CEDEAR calculation",
    tone: "neutral",
    ...
    bulletPoints: [
      ...
      "Ratio is structured mock data until official source integration is enabled.",
...
export async function getCedearAnalytics(symbol: string): Promise<CedearAnalytics | null> {
  ...
  return {
    ...
    warnings: [
      "Local CEDEAR price is mock until BYMA/IOL integration is enabled.",
      "CEDEAR ratio is mock/structured until official source integration is enabled.",
